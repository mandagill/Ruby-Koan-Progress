...
EOS
  ...
  def test_the_shovel_operator_will_also_append_content_to_a_string
    #So this only works in the direction that the operator is pointing
    hi = "Hello, "
    there = "World"
    hi << there
    assert_equal "Hello, World", hi
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #   Possibly because you know what it is that you're manipulating? This way when the first string changes, it stays changed so you know what you're dealing with
  end
  ...
  def test_you_can_get_a_substring_from_a_string
    ...
    #why does the line above behave that way? 7..20 returns 17 characters 
  end
