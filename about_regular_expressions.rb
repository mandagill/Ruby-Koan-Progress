...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_a_regexp_can_search_a_string_for_matching_content
    ...
    #this returns the string you're looking for OR nil
  end
  ...
  def test_character_classes_can_include_ranges
    assert_equal "2", "the number is 42"[/[0-3]+/]
    #This was originally 
    #assert_equal __, "the number is 42"[/[0-9]+/]
    #but I was kind of curious what would happen if I included in the string numbers outside of the regex range 
  end
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    #...but this is a capital a, why isn't it negative?   
  ...
  def test_caret_anchors_to_the_start_of_lines
    ...
    #__ was expected but is 2...this is the END of the line?
  end
  ...
  def test_variables_can_also_be_used_to_access_captures
    ...
    #dollar sign seeming to indicate a kind of number sign? not sure about this
  end
